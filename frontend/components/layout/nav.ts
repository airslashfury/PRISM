...
export const NAV: NavItem[] = [
  ...
  { href: "/weather", label: "Weather", icon: CloudSun, desc: "Puerto Rico's climate by municipio, plus a live-storm lens: the NHC forecast cone over PRISM's grid when a storm approaches", group: "Live" },
